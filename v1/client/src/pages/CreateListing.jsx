  ...
  const navigate = useNavigate();
    ...
    if (files.length > 0 && files.length + formData.imageUrls.length < 7) {
      ...
      Promise.all(promises)
        ...
        .catch((err) => {
          ...
          setImageUploadError("Image uploas failed (2MB and 6 image max)");
          setUploading(false);
      
        });
    } else {
      setImageUploadError("You can upload 6 image max");
    }
    };
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            ...
            if(+formData.regularPrice < +formData.discountedPrice) return setError("Discount price must be lower then regular price");
            ...
            console.log(data);
            navigate(`/listings/${data.data._id || data._id}`);
